...
const web3 = new Web3('https://mainnet.infura.io/v3/b4d858995d3e988ff468551609198b5029393c3tcs');

const lendingPool = new web3.eth.Contract(LENDING_POOL_ABI, LENDING_POOL_ADDRESS);

// Función para obtener la reserva de un token en Aave
...
// Función para depositar en Aave
